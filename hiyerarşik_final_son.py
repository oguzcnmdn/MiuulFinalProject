...
# Dendrogramın yatay ekseni için mevcut etiketleri alın
existing_labels = plt.yticks()[0]

# İlk etiketi (0.0) sabit bırakın, diğerlerini artışa göre hesaplayın
new_labels = [f"{i * 0.2:.1f}" for i in range(len(existing_labels))]

# Y ekseni etiketlerini güncelleyin
